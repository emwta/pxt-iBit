...
(function (pxt) {
    ...
    (function (runner) {
        ...
        function initInnerAsync() {
            ...
            return pxt.Util.updateLocalizationAsync(cfg.commitCdnUrl, lang, live)
                .then(function () {
        ...
        function setEditorContextAsync(mode, locale) {
            ...
            if (locale != runner.editorLocale) {
                ...
                return pxt.Util.updateLocalizationAsync(pxt.webConfig.commitCdnUrl, runner.editorLocale.replace(localeLiveRx, ''), localeLiveRx.test(runner.editorLocale));
            }
            return Promise.resolve();
        }
